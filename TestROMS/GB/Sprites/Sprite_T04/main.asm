...
;;  ==========
;;
;;  Creates 6 sprites: one at each corner of screen, each one using flips,
;;  and the last 2 in the middle center, forming a square.
...
Fill_Tile0: ; Filled with BGP[0]
    ...
    ; Sprite data 4 - Middle Center flipped
    ld A, $54
    ld [HL+], A ; Pos Y
    ld A, $54
    ld [HL+], A ; Pos X
